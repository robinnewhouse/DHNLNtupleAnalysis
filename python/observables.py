...
def selhistograms(histprefix): 
	# histograms after histprefix selection
	Observable(histprefix + "_plep_pt",binning = (1000,0,1000), do = ['hist']).queue()
	Observable(histprefix + "_plep_eta",binning = (40,-10,10),do = ['hist']).queue()
	Observable(histprefix + "_plep_phi", binning = (16,-4,4), do = ['hist']).queue()
	Observable(histprefix + "_plep_d0", do = ['hist']).queue()
	Observable(histprefix + "_plep_z0", do = ['hist']).queue()

	Observable(histprefix + "_DV_trk_pt",binning = (1000,0,1000), do = ['hist']).queue()
	Observable(histprefix + "_DV_trk_eta",binning = (160,-10,10),do = ['hist']).queue()
	Observable(histprefix + "_DV_trk_phi", binning =(64,-4,4), do = ['hist']).queue()
	Observable(histprefix + "_DV_trk_d0", do = ['hist']).queue()
	Observable(histprefix + "_DV_trk_z0", do = ['hist']).queue()
	Observable(histprefix + "_DV_trk_charge",binning = (11,-5.5,5.5), do = ['hist']).queue()
	Observable(histprefix + "_DV_trk_chi2",binning = (40,0,20), do = ['hist']).queue()
	Observable(histprefix + "_DV_trk_dpt",binning = (1000,0,1000), do = ['hist']).queue()
	Observable(histprefix + "_DV_trk_deta",binning = (80,0,10),do = ['hist']).queue()
	Observable(histprefix + "_DV_trk_dphi", binning = (16,0,4), do = ['hist']).queue()
	Observable(histprefix + "_DV_trk_dR", binning = (1000,0,10), do = ['hist']).queue()

	Observable(histprefix + "_DV_x",binning = (2000,-500,500), do = ['hist']).queue()
	Observable(histprefix + "_DV_y",binning = (2000,-500,500), do = ['hist']).queue()
	Observable(histprefix + "_DV_z",binning = (2000,-500,500), do = ['hist']).queue()
	Observable(histprefix + "_DV_r",binning = (500,0,500), do = ['hist']).queue()
	Observable(histprefix + "_DV_num_trks",binning = (6,-0.5,5.5), do = ['hist']).queue()
	Observable(histprefix + "_DV_distFromPV",binning = (500,0,500), do = ['hist']).queue()
	Observable(histprefix + "_DV_mass",binning = (10000,0,5000), do = ['hist']).queue()
	Observable(histprefix + "_DV_pt",binning = (1000,0,1000), do = ['hist']).queue()
	Observable(histprefix + "_DV_eta",binning = (160,-10,10),do = ['hist']).queue()
	Observable(histprefix + "_DV_phi", binning = (64,-4,4), do = ['hist']).queue()
	Observable(histprefix + "_DV_minOpAng",binning = (100,0,1), do = ['hist']).queue()
	Observable(histprefix + "_DV_maxOpAng",binning = (100,0,1), do = ['hist']).queue()
	Observable(histprefix + "_DV_charge",binning = (11,-5.5,5.5), do = ['hist']).queue()
	Observable(histprefix + "_DV_chi2",binning = (40,0,20), do = ['hist']).queue()
	Observable(histprefix + "_mvis",binning = (10000,0,5000), do = ['hist']).queue()
	Observable(histprefix + "_mhnl",binning = (10000,0,5000), do = ['hist']).queue()
...
# Observable("DVtype_DV_trk_eta",binning = (160,-10,10),do = ['hist']).queue()
# Observable("DVtype_DV_trk_phi", binning =(64,-4,4), do = ['hist']).queue()
...
# Observable("DVtype_DV_trk_dpt",binning = (1000,0,1000), do = ['hist']).queue()
# Observable("DVtype_DV_trk_deta",binning = (80,0,10),do = ['hist']).queue()
# Observable("DVtype_DV_trk_dphi", binning = (16,0,4), do = ['hist']).queue()
# Observable("DVtype_DV_trk_dR", binning = (1000,0,10), do = ['hist']).queue()
...
# Observable("DVtype_DV_eta",binning = (160,-10,10),do = ['hist']).queue()
# Observable("DVtype_DV_phi", binning = (64,-4,4), do = ['hist']).queue()
...
# Observable("DVtype_mvis",binning = (10000,0,5000), do = ['hist']).queue()
# Observable("DVtype_mhnl",binning = (10000,0,5000), do = ['hist']).queue()
# Observable("DVtype_mtrans",binning = (10000,0,5000), do = ['hist']).queue()
# Observable("DVtype_mtrans_rot",binning = (10000,0,5000), do = ['hist']).queue()
...
# Observable("trkqual_DV_trk_eta",binning = (160,-10,10),do = ['hist']).queue()
# Observable("trkqual_DV_trk_phi", binning =(64,-4,4), do = ['hist']).queue()
...
# Observable("trkqual_DV_trk_dpt",binning = (1000,0,1000), do = ['hist']).queue()
# Observable("trkqual_DV_trk_deta",binning = (80,0,10),do = ['hist']).queue()
# Observable("trkqual_DV_trk_dphi", binning = (16,0,4), do = ['hist']).queue()
# Observable("trkqual_DV_trk_dR", binning = (1000,0,10), do = ['hist']).queue()
...
# Observable("trkqual_DV_eta",binning = (160,-10,10),do = ['hist']).queue()
# Observable("trkqual_DV_phi", binning = (64,-4,4), do = ['hist']).queue()
...
# Observable("trkqual_mvis",binning = (10000,0,5000), do = ['hist']).queue()
# Observable("trkqual_mhnl",binning = (10000,0,5000), do = ['hist']).queue()
# Observable("trkqual_mtrans",binning = (10000,0,5000), do = ['hist']).queue()
# Observable("trkqual_mtrans_rot",binning = (10000,0,5000), do = ['hist']).queue()
...
# Observable("cosmic_DV_trk_eta",binning = (160,-10,10),do = ['hist']).queue()
# Observable("cosmic_DV_trk_phi", binning =(64,-4,4), do = ['hist']).queue()
...
# Observable("cosmic_DV_trk_dpt",binning = (1000,0,1000), do = ['hist']).queue()
# Observable("cosmic_DV_trk_deta",binning = (80,0,10),do = ['hist']).queue()
# Observable("cosmic_DV_trk_dphi", binning = (16,0,4), do = ['hist']).queue()
# Observable("cosmic_DV_trk_dR", binning = (1000,0,10), do = ['hist']).queue()
...
# Observable("cosmic_DV_eta",binning = (160,-10,10),do = ['hist']).queue()
# Observable("cosmic_DV_phi", binning = (64,-4,4), do = ['hist']).queue()
...
# Observable("cosmic_mvis",binning = (10000,0,5000), do = ['hist']).queue()
# Observable("cosmic_mhnl",binning = (10000,0,5000), do = ['hist']).queue()
# Observable("cosmic_mtrans",binning = (10000,0,5000), do = ['hist']).queue()
# Observable("cosmic_mtrans_rot",binning = (10000,0,5000), do = ['hist']).queue()
...
# Observable("mlll_DV_trk_eta",binning = (160,-10,10),do = ['hist']).queue()
# Observable("mlll_DV_trk_phi", binning =(64,-4,4), do = ['hist']).queue()
...
# Observable("mlll_DV_trk_dpt",binning = (1000,0,1000), do = ['hist']).queue()
# Observable("mlll_DV_trk_deta",binning = (80,0,10),do = ['hist']).queue()
# Observable("mlll_DV_trk_dphi", binning = (16,0,4), do = ['hist']).queue()
# Observable("mlll_DV_trk_dR", binning = (1000,0,10), do = ['hist']).queue()
...
# Observable("mlll_DV_eta",binning = (160,-10,10),do = ['hist']).queue()
# Observable("mlll_DV_phi", binning = (64,-4,4), do = ['hist']).queue()
...
# Observable("mlll_mvis",binning = (10000,0,5000), do = ['hist']).queue()
# Observable("mlll_mhnl",binning = (10000,0,5000), do = ['hist']).queue()
# Observable("mlll_mtrans",binning = (10000,0,5000), do = ['hist']).queue()
# Observable("mlll_mtrans_rot",binning = (10000,0,5000), do = ['hist']).queue()
