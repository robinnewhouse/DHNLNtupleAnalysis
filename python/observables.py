...
binning_definitions = {
	...
	'2lepMultitrk_num_trks': (21, -0.5, 20.5),
	'2lepMultitrk_muon_isAssociated': (2, -0.5, 1.5),
	'2lepMultitrk_bothmuon_isAssociated': (2, -0.5, 1.5),
	'2lepMultitrk_nomuon_isAssociated': (2, -0.5, 1.5),
	'2lepMultitrk_onemuon_isAssociated': (2, -0.5, 1.5),
	'2lepMultitrk_onetrk_isAssociated': (2, -0.5, 1.5),
	'2lepMultitrk_nonlep_trk_pt': (1000, 0, 1000),
	'2lepMultitrk_nonlep_trk_eta': (160, -10, 10),
	'2lepMultitrk_nonlep_trk_phi': (64, -4, 4),
	'2lepMultitrk_nonlep_trk_d0': (1000, -250, 250),
	'2lepMultitrk_nonlep_trk_z0': (3000, -1500, 1500),
	'2lepMultitrk_nonlep_trk_absz0': (1500, 0, 1500),
	'2lepMultitrk_nonlep_trk_charge': (11, -5.5, 5.5),
	'2lepMultitrk_nonlep_trk_chi2': (600, 0, 30),
	'2lepMultitrk_nonlep_trk_isLRT': (2, -0.5, 1.5),
	'2lepMultitrk_nonlep_trk_isSelected': (2, -0.5, 1.5),
	'2lepMultitrk_nonlep_trk_isAssociated': (2, -0.5, 1.5),
	'2lepMultitrk_nonlep_trk_nPixelHits': (15, -0.5, 14.5),
	'2lepMultitrk_nonlep_trk_nSCTHits': (15, -0.5, 14.5),
	'2lepMultitrk_nonlep_trk_nSCTHoles': (4, -0.5, 3.5),
	'2lepMultitrk_nonlep_trk_nSiHits': (24, -0.5, 23.5),
	'2lepMultitrk_nonlep_trk_dTheta': (500, 0, 250),
	'2lepMultitrk_nonlep_trk_chi2_toSV': (600, 0, 30),
	'2lepMultitrk_nonlep_trk_d0_wrtSV': (1000, -50, 50),
	'2lepMultitrk_nonlep_trk_errd0_wrtSV': (10000, 0, 50),
	'2lepMultitrk_nonlep_trk_z0_wrtSV': (3000, -30, 30),
	'2lepMultitrk_nonlep_trk_errz0_wrtSV': (10000, 0, 50),
	'2lepMultitrk_lep_trk_pt': (1000, 0, 1000),
	'2lepMultitrk_lep_trk_eta': (160, -10, 10),
	'2lepMultitrk_lep_trk_phi': (64, -4, 4),
	'2lepMultitrk_lep_trk_d0': (1000, -250, 250),
	'2lepMultitrk_lep_trk_z0': (3000, -1500, 1500),
	'2lepMultitrk_lep_trk_absz0': (1500, 0, 1500),
	'2lepMultitrk_lep_trk_charge': (11, -5.5, 5.5),
	'2lepMultitrk_lep_trk_chi2': (600, 0, 30),
	'2lepMultitrk_lep_trk_isLRT': (2, -0.5, 1.5),
	'2lepMultitrk_lep_trk_isSelected': (2, -0.5, 1.5),
	'2lepMultitrk_lep_trk_isAssociated': (2, -0.5, 1.5),
	'2lepMultitrk_lep_trk_nPixelHits': (15, -0.5, 14.5),
	'2lepMultitrk_lep_trk_nSCTHits': (15, -0.5, 14.5),
	'2lepMultitrk_lep_trk_nSCTHoles': (4, -0.5, 3.5),
	'2lepMultitrk_lep_trk_nSiHits': (24, -0.5, 23.5),
	'2lepMultitrk_lep_trk_dTheta': (500, 0, 250),
	'2lepMultitrk_lep_trk_chi2_toSV': (600, 0, 30),
	'2lepMultitrk_lep_trk_d0_wrtSV': (1000, -50, 50),
	'2lepMultitrk_lep_trk_errd0_wrtSV': (10000, 0, 50),
	'2lepMultitrk_lep_trk_z0_wrtSV': (3000, -30, 30),
	'2lepMultitrk_lep_trk_errz0_wrtSV': (10000, 0, 50),
	'2lepMultitrk_all_trk_pt': (1000, 0, 1000),
	'2lepMultitrk_all_trk_eta': (160, -10, 10),
	'2lepMultitrk_all_trk_phi': (64, -4, 4),
	'2lepMultitrk_all_trk_d0': (1000, -250, 250),
	'2lepMultitrk_all_trk_z0': (3000, -1500, 1500),
	'2lepMultitrk_all_trk_absz0': (1500, 0, 1500),
	'2lepMultitrk_all_trk_charge': (11, -5.5, 5.5),
	'2lepMultitrk_all_trk_chi2': (600, 0, 30),
	'2lepMultitrk_all_trk_isLRT': (2, -0.5, 1.5),
	'2lepMultitrk_all_trk_isSelected': (2, -0.5, 1.5),
	'2lepMultitrk_all_trk_isAssociated': (2, -0.5, 1.5),
	'2lepMultitrk_all_trk_nPixelHits': (15, -0.5, 14.5),
	'2lepMultitrk_all_trk_nSCTHits': (15, -0.5, 14.5),
	'2lepMultitrk_all_trk_nSCTHoles': (4, -0.5, 3.5),
	'2lepMultitrk_all_trk_nSiHits': (24, -0.5, 23.5),
	'2lepMultitrk_all_trk_dTheta': (500, 0, 250),
	'2lepMultitrk_all_trk_chi2_toSV': (600, 0, 30),
	'2lepMultitrk_all_trk_d0_wrtSV': (1000, -50, 50),
	'2lepMultitrk_all_trk_errd0_wrtSV': (10000, 0, 50),
	'2lepMultitrk_all_trk_z0_wrtSV': (3000, -30, 30),
	'2lepMultitrk_all_trk_errz0_wrtSV': (10000, 0, 50),
...
for i in range(8):
	binning_definitions['2lepMultitrk_num_assoc_{}trk'.format(i)] = (21, -0.5, 20.5)
