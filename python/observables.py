...
def selhistograms(histprefix): 
	...
	Observable(histprefix + "_DV_trk_dpt",binning = (2000,0,1000), do = ['hist']).queue()
	Observable(histprefix + "_DV_trk_deta",binning = (160,0,20),do = ['hist']).queue()
	Observable(histprefix + "_DV_trk_dphi", binning = (64,0,8), do = ['hist']).queue()
	...
	Observable(histprefix + "_HNLm",binning = (10000,0,5000), do = ['hist']).queue()
	Observable(histprefix + "_HNLpt",binning = (1000,0,1000), do = ['hist']).queue()
	Observable(histprefix + "_HNLeta",binning = (160,-10,10),do = ['hist']).queue()
