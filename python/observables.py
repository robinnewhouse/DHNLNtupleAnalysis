...
def truth_histograms(selection): 
	...
	Observable("truth_" + selection + "_nu_trk_pt", binning=(1000, 0, 1000), do=['hist'], need_truth=True).queue()
	Observable("truth_" + selection + "_nu_trk_eta", binning=(160, -10, 10), do=['hist'], need_truth=True).queue()
	Observable("truth_" + selection + "_nu_trk_phi", binning=(64, -4, 4), do=['hist'], need_truth=True).queue()
	...
	Observable("truth_" + selection + "_DV_mass",binning = (200,0,100), do = ['hist'], need_truth = True).queue()
	Observable("truth_" + selection + "_m12",binning = (200,0,100), do = ['hist'], need_truth = True).queue()
	Observable("truth_" + selection + "_m23",binning = (200,0,100), do = ['hist'], need_truth = True).queue()
	Observable("truth_" + selection + "_m13",binning = (200,0,100), do = ['hist'], need_truth = True).queue()
	Observable("truth_" + selection + "_m12_sq",binning = (200,0,100), do = ['hist'], need_truth = True).queue()
	Observable("truth_" + selection + "_m23_sq",binning = (200,0,100), do = ['hist'], need_truth = True).queue()
	Observable("truth_" + selection + "_m13_sq",binning = (200,0,100), do = ['hist'], need_truth = True).queue()
	Observable("truth_" + selection + "_s23",binning = (200,0,100), do = ['hist'], need_truth = True).queue()
	Observable("truth_" + selection + "_s24",binning = (200,0,100), do = ['hist'], need_truth = True).queue()
	Observable("truth_" + selection + "_s34",binning = (200,0,100), do = ['hist'], need_truth = True).queue()
	Observable("truth_" + selection + "_s12",binning = (12000,0,6000), do = ['hist'], need_truth = True).queue()
	Observable("truth_" + selection + "_s13",binning = (12000,0,6000), do = ['hist'], need_truth = True).queue()
	Observable("truth_" + selection + "_s14",binning = (12000,0,6000), do = ['hist'], need_truth = True).queue()
	Observable("truth_" + selection + "_m13",binning = (200,0,100), do = ['hist'], need_truth = True).queue()
