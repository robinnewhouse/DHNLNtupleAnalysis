...
def main():
    ...
    h["SS_dlep1_pt"] = ROOT.TH1D('h_SS_dlep1_pt', 'h_SS_dlep1_pt', 50, 0, 200)
    h["SS_dlep1_eta"] = ROOT.TH1D('h_SS_dlep1_eta', 'h_SS_dlep1_eta', 100, -3, 3)
    h["SS_dlep2_phi"] = ROOT.TH1D('h_SS_dlep2_phi', 'h_SS_dlep2_phi', 100, -4, 4)
    h["SS_dlep2_pt"] = ROOT.TH1D('h_SS_dlep2_pt', 'h_SS_dlep2_pt', 50, 0, 200)
    h["SS_dlep2_eta"] = ROOT.TH1D('h_SS_dlep2_eta', 'h_SS_dlep2_eta', 100, -3, 3)
    h["delp2_phi"] = ROOT.TH1D('h_delp2_phi', 'h_delp2_phi', 100, -4, 4)
    ...
    h["OS_dlep1_pt"] = ROOT.TH1D('h_OS_dlep1_pt', 'h_OS_dlep1_pt', 50, 0, 200)
    h["OS_dlep1_eta"] = ROOT.TH1D('h_OS_dlep1_eta', 'h_OS_dlep1_eta', 100, -3, 3)
    h["OS_dlep2_phi"] = ROOT.TH1D('h_OS_dlep2_phi', 'h_OS_dlep2_phi', 100, -4, 4)
    h["OS_dlep2_pt"] = ROOT.TH1D('h_OS_dlep2_pt', 'h_OS_dlep2_pt', 50, 0, 200)
    h["OS_dlep2_eta"] = ROOT.TH1D('h_OS_dlep2_eta', 'h_OS_dlep2_eta', 100, -3, 3)
