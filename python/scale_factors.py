...
electron_id = {'nominal': 0, 'down': 1, 'up': 2}
...
electron_trig = {'nominal': 0, 'down': 1, 'up': 2}
...
def get_trigger_scale_factor(analysis, systematic='nominal'):
    ...
    if lep_type == 'muon':
        ...
        if len(trigger_scale_factor_mu26_ivarmedium) > 1: # get systematic
            trigger_scale_factor_mu26_ivarmedium = trigger_scale_factor_mu26_ivarmedium[muon_trig[systematic]]
        else:
            trigger_scale_factor_mu26_ivarmedium = trigger_scale_factor_mu26_ivarmedium[muon_trig['nominal']]
        ...
        if len(trigger_scale_factor_mu20_iloose_L1MU15) > 1: # get systematic
            trigger_scale_factor_mu20_iloose_L1MU15 = trigger_scale_factor_mu20_iloose_L1MU15[muon_trig[systematic]]
        else:
            trigger_scale_factor_mu20_iloose_L1MU15 = trigger_scale_factor_mu20_iloose_L1MU15[muon_trig['nominal']]
    ...
    if lep_type == 'electron':
        ...
        ][lep_index][electron_trig[systematic]]
...
def get_reco_scale_factor(analysis, systematic='nominal'):
    ...
    if analysis.plep == 'muon':
        prompt_lepton_scale_factor = analysis.tree['muon_RecoEff_SF_RecoMedium'][analysis.plep_sel.plep_index][muon_reco[systematic]]
    elif analysis.plep == 'electron':
        prompt_lepton_scale_factor = analysis.tree['el_PIDEff_SF_Medium'][analysis.plep_sel.plep_index][electron_id[systematic]]
        prompt_lepton_scale_factor *= analysis.tree['el_RecoEff_SF'][analysis.plep_sel.plep_index][electron_reco[systematic]]  # electron SF is split into ID and Reco

    # get displaced scale factors depending on type
    if analysis.dv_type == 'mumu':
        displaced_lepton_0_scale_factor = analysis.tree.get('muon_RecoEff_SF_RecoMedium')[muons.lepIndex[0]][muon_reco[systematic]]
        displaced_lepton_1_scale_factor = analysis.tree.get('muon_RecoEff_SF_RecoMedium')[muons.lepIndex[1]][muon_reco[systematic]]
    if analysis.dv_type == 'emu':
        displaced_lepton_0_scale_factor = analysis.tree.get('muon_RecoEff_SF_RecoMedium')[muons.lepIndex[0]][muon_reco[systematic]]
        displaced_lepton_1_scale_factor = analysis.tree.get('el_PIDEff_SF_LooseBLayer')[electrons.lepIndex[0]][electron_id[systematic]]
        displaced_lepton_1_scale_factor *= analysis.tree.get('el_RecoEff_SF')[electrons.lepIndex[0]][electron_reco[systematic]]  # electron SF is split into ID and Reco
    if analysis.dv_type == 'ee':
        displaced_lepton_0_scale_factor = analysis.tree.get('el_PIDEff_SF_LooseBLayer')[electrons.lepIndex[0]][electron_id[systematic]]
        displaced_lepton_0_scale_factor *= analysis.tree.get('el_RecoEff_SF')[electrons.lepIndex[0]][electron_reco[systematic]]  # electron SF is split into ID and Reco
        displaced_lepton_1_scale_factor = analysis.tree.get('el_PIDEff_SF_LooseBLayer')[electrons.lepIndex[1]][electron_id[systematic]]
        displaced_lepton_1_scale_factor *= analysis.tree.get('el_RecoEff_SF')[electrons.lepIndex[1]][electron_reco[systematic]]  # electron SF is split into ID and Reco
